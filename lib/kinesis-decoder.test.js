...
describe('kinesis-decoder', () => {
  ...
  it('decodes an event', async () => {
    ...
    expect(results['b1b7946d-50ad-47b9-a9df-df759071aac9/e44AyWZHufBjPRC92aOaaTRHmc4wecVTM6d3ey4DgLY'].bytes.length).toEqual(1)
    expect(results['23bad054-b988-475f-b345-4a5f41dcf61e/MBZD8EhnrQt7FNSqlMUFaghdq8RPrDZUWRLvKNA0o14'].bytes.length).toEqual(1)
    expect(results['6b2a0f7d-a668-4957-94a1-9a8a2587b908/OFGIxCNq2fLa6Yb6tL18SF-wLnzQ4vKpi_xgzUKC0Y0'].bytes.length).toEqual(2)
  })

  it('simplifies event data', async () => {
    const results = await decoder.decodeEvent(EVENT)
    expect(results['b1b7946d-50ad-47b9-a9df-df759071aac9/e44AyWZHufBjPRC92aOaaTRHmc4wecVTM6d3ey4DgLY']).toMatchObject({
      time: 1537990270526,
      region: 'us-west-2',
      total: 70122363,
      bytes: ['0-70122362']
    })
    expect(results['6b2a0f7d-a668-4957-94a1-9a8a2587b908/OFGIxCNq2fLa6Yb6tL18SF-wLnzQ4vKpi_xgzUKC0Y0']).toMatchObject({
      time: 1537990284309,
      region: 'us-west-2',
      total: 120766431,
  ...
  it('decodes a single data', async () => {
    ...
    expect(results[0]).toMatchObject({
      ls: 'b1b7946d-50ad-47b9-a9df-df759071aac9',
